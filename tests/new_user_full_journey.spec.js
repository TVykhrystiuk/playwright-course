...
import { ProductsPage } from "../page-objects/ProductsPage.js"  // each . move us one folder up (to previous)
...
test("New user full end-to-end test jorney", async ({page}) =>{
    ...
    // const emailId = uuidv4() // generate random UUID
    const email = uuidv4() + "@gmail.com" // arei-3232-dfr4@gmail.com
